 ...
 * @UniqueEntity(
 *    fields={"email"},
 *     message="cet email est déja utilisée.",groups={"registration"}
 * )
 */
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     *     match=true,
     *     message="le mot de passe doit contenir au moins un caractére spéciale un lettre minuscule un lettre majuscule et un chiffre ",groups={"registration"}
     * )
     ...
     *     message="les deux mot de passe ne sont pas identique",groups={"registration"}
     * )
     *  Assert\NotBlank(message="vous devez confirmer votre mot de passe",groups={"registration"})
     */
     ...
     *     pattern="#(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}#",
     *     match=true,
     *     message="le mot de passe doit contenir au moins un caractére spéciale un lettre minuscule un lettre majuscule et un chiffre "
     * )
